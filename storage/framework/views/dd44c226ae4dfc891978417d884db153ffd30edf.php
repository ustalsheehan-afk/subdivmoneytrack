...
<?php $__env->startSection('page-title', 'Amenities Management'); ?>
    ...
    <div class="glass-card p-8 relative overflow-hidden group">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
            ...
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('admin.amenities.create')); ?>" class="btn-premium">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-emerald-50/30 transition-all duration-300 group border-l-4 border-transparent hover:border-emerald-500">
                            ...
                            <div class="flex items-center gap-4">
                                <div class="relative shrink-0">
                                    <?php if($amenity->image): ?>
                                        <img src="<?php echo e(Storage::url($amenity->image)); ?>" class="w-14 h-14 rounded-2xl object-cover shadow-sm group-hover:scale-105 transition-transform duration-500 border border-gray-100" alt="<?php echo e($amenity->name); ?>">
                                    <?php else: ?>
                                ...
                                <div class="min-w-0">
                                    <p class="text-base font-black text-gray-900 group-hover:text-emerald-700 transition-colors truncate"><?php echo e($amenity->name); ?></p>
                                    <p class="text-[11px] text-gray-500 font-medium line-clamp-1 mt-0.5"><?php echo e($amenity->description); ?></p>
                                </div>
                            </div>
                        </td>
                        <td class="p-5 text-center">
                            <div class="flex flex-col items-center">
                                <span class="text-base font-black text-gray-900 tabular-nums"><?php echo e($amenity->max_capacity); ?></span>
                                <span class="text-[9px] font-black text-gray-400 uppercase tracking-widest mt-0.5">PAX Max</span>
                            </div>
                        </td>
                        <td class="p-5 text-center">
                            <div class="flex flex-col items-center">
                                <span class="text-base font-black text-emerald-600 tabular-nums">₱<?php echo e(number_format($amenity->price, 2)); ?></span>
                        ...
                        <td class="p-5 text-center">
                            ...
                            ?>
                            <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest border <?php echo e($statusColors[$amenity->status] ?? 'bg-gray-50 text-gray-600 border-gray-100'); ?>">
                                <span class="w-1.5 h-1.5 rounded-full <?php echo e($statusDots[$amenity->status] ?? 'bg-gray-400'); ?>"></span>
                                <?php echo e($amenity->status); ?>

                            </span>
                        </td>
                        <td class="p-5 text-center">
                            <div class="flex items-center justify-center gap-2">
                                <a href="<?php echo e(route('admin.amenities.edit', $amenity)); ?>" class="w-9 h-9 flex items-center justify-center rounded-xl bg-gray-900 text-white hover:bg-emerald-600 transition-all shadow-sm" title="Edit Amenity">
                                    <i class="bi bi-pencil-square"></i>
                                </a>
                                <form action="<?php echo e(route('admin.amenities.destroy', $amenity)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this amenity?');">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views\admin\amenities\index.blade.php ENDPATH**/ ?>