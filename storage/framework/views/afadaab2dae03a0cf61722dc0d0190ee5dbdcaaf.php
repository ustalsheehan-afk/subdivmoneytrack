...
<?php $__env->startSection('page-title', 'Edit Announcement'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-32">
    <form method="POST" action="<?php echo e(route('admin.announcements.update', $announcement)); ?>" enctype="multipart/form-data" id="announcementForm">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>
        <input type="hidden" name="status" id="form-status" value="<?php echo e($announcement->status); ?>">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="category" id="input-category" 
                                        ...
                                        required>
                                    <?php $__currentLoopData = ['Event','Maintenance','Meeting','Security','Finance','Emergency']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($cat); ?>" <?php echo e(old('category', $announcement->category) == $cat ? 'selected' : ''); ?>>
                                            <?php echo e($cat); ?>
                            ...
                            <div>
                                ...
                                <select name="priority" id="input-priority" 
                                        class="w-full px-4 py-3 rounded-[10px] border border-gray-200 bg-gray-50/50 text-sm focus:ring-2 focus:ring-[#B6FF5C] focus:border-[#B6FF5C] focus:bg-white focus:outline-none transition-all duration-300 cursor-pointer">
                                    <option value="normal" <?php echo e(in_array(old('priority', $announcement->priority), ['normal', 'fyi']) ? 'selected' : ''); ?>>FYI (Normal)</option>
                                    <option value="high" <?php echo e(in_array(old('priority', $announcement->priority), ['high', 'important']) ? 'selected' : ''); ?>>Important</option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="datetime-local"
                                       ...
                                       value="<?php echo e(old('date_posted', $announcement->date_posted->format('Y-m-d\TH:i'))); ?>"
                                       required>
                            </div>
                            ...
                            <div class="p-4 bg-gray-50 rounded-[12px] border border-gray-100 flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    <div class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" name="is_pinned" id="is_pinned" value="1" <?php echo e(old('is_pinned', $announcement->is_pinned) ? 'checked' : ''); ?> class="sr-only peer">
                            ...
                            <label class="group flex flex-col items-center justify-center w-full h-32 border-2 border-gray-200 border-dashed rounded-[12px] bg-gray-50/50 hover:bg-white hover:border-[#B6FF5C] hover:border-solid cursor-pointer transition-all duration-300">
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p id="file-name" class="text-sm text-gray-500 group-hover:text-gray-700 transition-colors font-medium">
                                        <?php echo e($announcement->image ? 'Change current image...' : 'Click to upload or drag and drop'); ?>
                ...
                <div class="glass-card bg-white border border-gray-100 rounded-[12px] shadow-lg overflow-hidden flex flex-col min-h-[500px]">
                    ...
                    <div class="p-8 flex-1 flex flex-col">
                        ...
                        <div class="relative pl-8">
                            ...
                            <div id="preview-image-container" class="<?php echo e($announcement->image ? '' : 'hidden'); ?> rounded-2xl overflow-hidden border border-gray-100 shadow-sm mb-6">
                                <img id="preview-image" src="<?php echo e($announcement->image ? asset('storage/'.$announcement->image) : '#'); ?>" alt="Preview" class="w-full h-auto object-cover max-h-[300px]">
                            </div>
                            ...
                            <div class="flex items-center gap-6 mt-auto pt-6 border-t border-gray-50">
                                <div class="flex items-center gap-1.5 text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                                    ...
                                    <span><?php echo e($announcement->readers()->count()); ?> / <?php echo e(\App\Models\Resident::where('status', 'active')->count()); ?> Seen</span>
                                </div>
                                <div class="flex items-center gap-1.5 text-[10px] font-bold text-gray-400 uppercase tracking-widest">
        ...
        <div class="fixed bottom-0 right-0 left-0 lg:left-72 bg-white/80 backdrop-blur-md border-t border-gray-100 p-6 z-40 transition-all duration-300">
            <div class="max-w-7xl mx-auto flex items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-3 w-full md:w-auto">
                    ...
                    <?php endif; ?>
                    <button type="submit" <?php if($announcement->status === 'draft'): ?> onclick="prepareDraftPublish()" <?php endif; ?>
                        ...
                        <?php echo e($announcement->status === 'draft' ? 'Publish Announcement' : 'Update Announcement'); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    inputs.image.addEventListener('change', function() {
        ...
        if (file) {
            ...
            fileNameDisplay.textContent = '<?php echo e($announcement->image ? 'Change current image...' : 'Click to upload or drag and drop'); ?>';
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views\admin\announcements\edit.blade.php ENDPATH**/ ?>