<?php $__env->startSection('title', 'Add Penalty'); ?>
<?php $__env->startSection('page-title', 'Add New Penalty'); ?>
...
<div class="space-y-8 animate-fade-in pb-20" x-data="penaltyForm()">
    ...
    <form id="penalty-form" action="<?php echo e(route('admin.penalties.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 gap-8">
                                ...
                                <select name="resident_id" id="resident_id" x-model="residentId" @change="updateResidentPreview" 
                                    ...
                                    <?php $__currentLoopData = $residents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resident): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($resident->id); ?>" 
                                            data-name="<?php echo e($resident->full_name); ?>"
                                            data-property="Block <?php echo e($resident->block); ?> / Lot <?php echo e($resident->lot); ?>"
                                            data-initials="<?php echo e(substr($resident->first_name, 0, 1)); ?><?php echo e(substr($resident->last_name, 0, 1)); ?>"
                                            <?php echo e(old('resident_id') == $resident->id ? 'selected' : ''); ?>>
                                            <?php echo e($resident->full_name); ?> (B<?php echo e($resident->block); ?> L<?php echo e($resident->lot); ?>)
                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-3">
                                ...
                                <input type="date" name="date_issued" id="date_issued" value="<?php echo e(old('date_issued', date('Y-m-d'))); ?>" 
                        ...
                        <div class="space-y-3">
                            ...
                            <textarea name="reason" id="reason" rows="4" 
                                ...
                                placeholder="Describe the violation in detail..." required><?php echo e(old('reason')); ?></textarea>
                        </div>
                    </div>
                </section>
                ...
                <div class="glass-card p-8 space-y-6 relative overflow-hidden group">
                    ...
                    <div class="flex p-1.5 bg-gray-50 rounded-2xl border border-gray-100">
                        <label class="flex-1 cursor-pointer">
                            <input type="radio" name="status" value="unpaid" class="peer hidden" <?php echo e(old('status', 'unpaid') == 'unpaid' ? 'checked' : ''); ?>>
                        ...
                        <label class="flex-1 cursor-pointer">
                            <input type="radio" name="status" value="paid" class="peer hidden" <?php echo e(old('status') == 'paid' ? 'checked' : ''); ?>>
...
<script>
    function penaltyForm() {
        return {
            residentId: '<?php echo e(old('resident_id')); ?>',
            residentName: '',
            residentProperty: '',
            residentInitials: '',
            penaltyType: '<?php echo e(old('type', 'general')); ?>',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views\admin\penalties\create.blade.php ENDPATH**/ ?>