                ...
                <div class="space-y-6 relative z-10">
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between p-6 rounded-[28px] bg-gray-50 border border-gray-100 hover:bg-white hover:shadow-xl transition-all duration-500 group/item">
                        <div class="mb-4 sm:mb-0">
                            ...
                            <span class="text-sm font-black text-gray-900 tracking-tight"><?php echo e($resident->first_name); ?> <?php echo e($resident->last_name); ?></span>
                        </div>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between p-6 rounded-[28px] bg-gray-50 border border-gray-100 hover:bg-white hover:shadow-xl transition-all duration-500 group/item">
                        <div>
                            ...
                            <span class="text-sm font-black text-gray-900 tracking-tight break-all"><?php echo e($resident->email); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('resident.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views\resident\profile\settings.blade.php ENDPATH**/ ?>