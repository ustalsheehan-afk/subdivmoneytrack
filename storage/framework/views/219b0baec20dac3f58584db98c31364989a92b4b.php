    ...
    <div class="p-6 space-y-7">
        ...
        <div class="space-y-3">
            ...
            <p class="text-sm text-gray-500">
                Posted on <?php echo e($announcement->date_posted->format('F d, Y \a\t h:i A')); ?>
        ...
        <?php if($announcement->is_pinned && $announcement->pin_expires_at): ?>
                ...
                <div class="space-y-0.5">
                    ...
                    <p>
                        ...
                        <span class="font-medium">
                            <?php echo e($announcement->pin_expires_at->format('M d, Y')); ?>
        ...
        <div class="pt-5 border-t border-gray-200">
            <form action="<?php echo e(route('admin.announcements.destroy', $announcement)); ?>"
                  method="POST"
...
<?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views\admin\announcements\partials\drawer.blade.php ENDPATH**/ ?>