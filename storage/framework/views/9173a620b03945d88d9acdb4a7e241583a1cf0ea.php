...
<?php $__env->startSection('page-title', 'Profile Setup'); ?>
    ...
    <div class="max-w-2xl mx-auto px-6 py-12 pb-24 animate-fade-in">
        ...
        <?php if(session('success')): ?>
            <div class="mb-8 p-6 bg-emerald-500/10 border border-emerald-500/20 rounded-[28px] flex items-center gap-4 animate-bounce">
                ...
                <p class="text-emerald-700 text-sm font-black uppercase tracking-widest"><?php echo e(session('success')); ?></p>
            </div>
        <?php endif; ?>
        ...
        <div class="bg-white rounded-[40px] border border-gray-100 shadow-2xl p-10 relative overflow-hidden group">
            ...
            <form method="POST" action="<?php echo e(route('resident.profile.update')); ?>" class="relative z-10 space-y-8">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input id="name" name="name" 
                                   ...
                                   value="<?php echo e(old('name', $user->name ?? '')); ?>" placeholder="Enter your full name" required>
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input id="address" name="address" 
                                   class="w-full bg-gray-50 border border-gray-100 rounded-2xl pl-14 pr-6 py-4 text-sm font-black text-gray-900 focus:bg-white focus:ring-4 focus:ring-emerald-500/5 focus:border-emerald-500 transition-all outline-none"
                                   value="<?php echo e(old('address', $user->address ?? '')); ?>" placeholder="Your subdivision address" required>
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input id="block_lot" name="block_lot" 
                                   class="w-full bg-gray-50 border border-gray-100 rounded-2xl pl-14 pr-6 py-4 text-sm font-black text-gray-900 focus:bg-white focus:ring-4 focus:ring-emerald-500/5 focus:border-emerald-500 transition-all outline-none"
                                   value="<?php echo e(old('block_lot', $user->block_lot ?? '')); ?>" placeholder="e.g. Block 1 Lot 2" required>
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input id="contact" name="contact_number" 
                                   class="w-full bg-gray-50 border border-gray-100 rounded-2xl pl-14 pr-6 py-4 text-sm font-black text-gray-900 focus:bg-white focus:ring-4 focus:ring-emerald-500/5 focus:border-emerald-500 transition-all outline-none"
                                   value="<?php echo e(old('contact_number', $user->resident?->contact_number ?? '')); ?>" placeholder="09XX XXX XXXX" required>
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input id="email" name="email" type="email" 
                                   class="w-full bg-gray-50 border border-gray-100 rounded-2xl pl-14 pr-6 py-4 text-sm font-black text-gray-900 focus:bg-white focus:ring-4 focus:ring-emerald-500/5 focus:border-emerald-500 transition-all outline-none"
                                   value="<?php echo e(old('email', $user->email ?? '')); ?>" placeholder="your@email.com" required>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('resident.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views\resident\profile\setup.blade.php ENDPATH**/ ?>