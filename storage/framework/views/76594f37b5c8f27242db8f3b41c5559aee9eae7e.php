<div class="bg-white p-8 md:p-12 shadow-sm rounded-2xl border border-gray-100 max-w-4xl mx-auto print:shadow-none print:border-none print:p-0">
    ...
    <div class="text-center mb-10 border-b pb-8 border-gray-100">
        <h1 class="text-2xl font-black text-gray-900 uppercase tracking-widest"><?php echo e(config('app.name', 'Subdivision Association')); ?></h1>
        <h2 class="text-lg font-bold text-gray-700 mt-1">Statement of Financial Position</h2>
        <p class="text-sm text-gray-500 mt-2 italic font-medium">As of <?php echo e($results['as_of']); ?></p>
    ...
    <div class="space-y-10">
        ...
        <div>
            ...
            <div class="mb-6">
                ...
                <div class="space-y-2 pl-4">
                    ...
                    <div class="flex justify-between text-sm">
                        ...
                        <span class="font-mono text-gray-900"><?php echo e(number_format($amount, 2)); ?></span>
                    </div>
            ...
            <div class="flex justify-between items-center py-3 border-t-2 border-gray-900 font-black text-gray-900 uppercase tracking-widest text-sm bg-gray-50/50 px-4 rounded">
                ...
                <span class="font-mono border-b-4 border-double border-gray-900">₱ <?php echo e(number_format($results['total_assets'], 2)); ?></span>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="flex justify-between items-center py-2 border-t border-gray-300 font-bold text-gray-900 text-sm mb-8 px-4">
                ...
                <span class="font-mono underline"><?php echo e(number_format($results['total_liabilities'], 2)); ?></span>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="flex justify-between items-center py-2 mt-2 font-bold text-gray-900 text-sm px-4">
                    ...
                    <span class="font-mono underline"><?php echo e(number_format($results['total_equity'], 2)); ?></span>
                </div>
            </div>

            <div class="flex justify-between items-center py-3 border-t-2 border-gray-900 font-black text-gray-900 uppercase tracking-widest text-sm bg-gray-50/50 px-4 rounded">
                <span>TOTAL LIABILITIES AND EQUITY</span>
                <span class="font-mono border-b-4 border-double border-gray-900">₱ <?php echo e(number_format($results['total_liabilities'] + $results['total_equity'], 2)); ?></span>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views\admin\reports\partials\statement_financial_position.blade.php ENDPATH**/ ?>