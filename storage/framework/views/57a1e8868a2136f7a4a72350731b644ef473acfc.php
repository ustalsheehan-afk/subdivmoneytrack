<div class="payment-card bg-white rounded-[24px] p-6 border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative group overflow-hidden">
    ...
    <div class="flex flex-col items-center text-center mt-4 relative z-10">
        ...
        <div class="w-full mt-6">
            <a href="<?php echo e(route('admin.payments.review', $payment->id)); ?>" class="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-gray-900 text-white text-[10px] font-black uppercase tracking-widest hover:bg-emerald-600 transition-all shadow-lg active:scale-95">
                <i class="bi bi-eye-fill"></i>
                Review Payment
            </a>
        </div>
    </div>
</div><?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views\admin\payments\partials\card.blade.php ENDPATH**/ ?>