...
<?php $__env->startSection('page-title', 'Penalties Management'); ?>
...
<div class="space-y-8 animate-fade-in" x-data="penaltiesBulkApproval()" x-cloak>
    ...
    <div class="glass-card p-8 relative overflow-hidden group">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
            ...
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('admin.smsTemplates.index')); ?>" class="btn-secondary">
                    <i class="bi bi-chat-left-text"></i>
                    SMS Templates
                </a>
                <form method="POST" action="<?php echo e(route('admin.penalties.sendSmsNotices')); ?>">
                    <?php echo csrf_field(); ?>
                ...
                <a href="<?php echo e(route('admin.penalties.create')); ?>" class="btn-premium">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="glass-card p-6 relative overflow-hidden group">
            ...
            <div class="relative z-10 space-y-2">
                ...
                <h3 class="text-2xl font-black text-gray-900 tracking-tight"><?php echo e($totalCount); ?></h3>
        ...
        <div class="glass-card p-6 relative overflow-hidden group">
            ...
            <div class="relative z-10 space-y-2">
                ...
                <h3 class="text-2xl font-black text-gray-900 tracking-tight">₱<?php echo e(number_format($totalPaid, 2)); ?></h3>
                <div class="flex items-center gap-2 pt-2">
        ...
        <div class="glass-card p-6 relative overflow-hidden group">
            ...
            <div class="relative z-10 space-y-2">
                ...
                <h3 class="text-2xl font-black text-gray-900 tracking-tight">₱<?php echo e(number_format($totalPending, 2)); ?></h3>
                <div class="flex items-center gap-2 pt-2">
        ...
        <div class="glass-card p-6 relative overflow-hidden group">
            ...
            <div class="relative z-10 space-y-2">
                ...
                <h3 class="text-2xl font-black text-gray-900 tracking-tight">₱<?php echo e(number_format($totalUnpaid, 2)); ?></h3>
                <div class="flex items-center gap-2 pt-2">
    ...
    <div class="glass-card p-4 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        ...
        <div class="flex-1 max-w-md">
            <form method="GET" action="<?php echo e(route('admin.penalties.index')); ?>" class="relative group">
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <div class="relative group/filter">
                ...
                <div id="statusDropdown" class="hidden absolute right-0 top-full mt-2 w-48 bg-white rounded-xl shadow-xl border border-gray-100 z-50 py-2">
                    ...
                    <a href="<?php echo e(request()->fullUrlWithQuery(['status' => 'paid'])); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-emerald-50 hover:text-emerald-700 font-medium transition-colors">Paid</a>
                    <a href="<?php echo e(request()->fullUrlWithQuery(['status' => 'unpaid'])); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-emerald-50 hover:text-emerald-700 font-medium transition-colors">Unpaid</a>
                </div>
            </div>
            ...
            <div class="relative group/filter">
                ...
                <div id="typeDropdown" class="hidden absolute right-0 top-full mt-2 w-56 bg-white rounded-xl shadow-xl border border-gray-100 z-50 py-2">
                    ...
                    <a href="<?php echo e(request()->fullUrlWithQuery(['type' => null])); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-emerald-50 hover:text-emerald-700 font-medium transition-colors">All Types</a>
                    <a href="<?php echo e(request()->fullUrlWithQuery(['type' => 'late_payment'])); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-emerald-50 hover:text-emerald-700 font-medium transition-colors">Late Payment</a>
                    <a href="<?php echo e(request()->fullUrlWithQuery(['type' => 'overdue'])); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-emerald-50 hover:text-emerald-700 font-medium transition-colors">Overdue</a>
                    <a href="<?php echo e(request()->fullUrlWithQuery(['type' => 'violation'])); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-emerald-50 hover:text-emerald-700 font-medium transition-colors">Violation</a>
                    <a href="<?php echo e(request()->fullUrlWithQuery(['type' => 'damage'])); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-emerald-50 hover:text-emerald-700 font-medium transition-colors">Damage</a>
                </div>
            </div>

            
            <?php if(request()->anyFilled(['search', 'status', 'type', 'block', 'lot'])): ?>
                <a href="<?php echo e(route('admin.penalties.index')); ?>" class="h-11 w-11 flex items-center justify-center rounded-xl border border-red-100 text-red-500 hover:bg-red-50 transition-all" title="Clear All Filters">
                    <i class="bi bi-x-lg"></i>
                </a>
            <?php endif; ?>
        </div>
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-emerald-50/30 transition-all duration-300 group border-l-4 border-transparent hover:border-emerald-500">
                        ...
                        <td class="p-5">
                            <div class="flex items-center gap-4">
                                <div class="w-11 h-11 rounded-2xl bg-emerald-50 text-emerald-600 flex items-center justify-center font-black text-xs border border-emerald-100 shadow-sm">
                                    <?php echo e(strtoupper(substr($penalty->resident?->first_name ?? 'R', 0, 1))); ?><?php echo e(strtoupper(substr($penalty->resident?->last_name ?? 'S', 0, 1))); ?>

                                </div>
                                <div>
                                    <p class="font-bold text-gray-900 group-hover:text-emerald-700 transition-colors"><?php echo e($penalty->resident?->full_name ?? 'Unknown Resident'); ?></p>
                                    <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mt-0.5">B<?php echo e($penalty->resident?->block ?? '-'); ?> / L<?php echo e($penalty->resident?->lot ?? '-'); ?></p>
                                </div>
                            </div>
                        </td>
                        <td class="p-5">
                        ...
                        <td class="p-5">
                            <span class="text-sm font-medium text-gray-600 truncate max-w-[200px] block" title="<?php echo e($penalty->reason); ?>">
                                <?php echo e($penalty->reason); ?>

                            </span>
                        </td>
                        <td class="p-5 text-center">
                            <span class="text-sm font-bold text-gray-500"><?php echo e($penalty->created_at->format('M d, Y')); ?></span>
                        </td>
                        <td class="p-5 text-right">
                            <span class="text-base font-black text-gray-900">₱<?php echo e(number_format($penalty->amount, 2)); ?></span>
                        </td>
                        <td class="p-5 text-center">
                            <?php
                                $statusColors = [
                            ...
                            ?>
                            <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest border <?php echo e($statusColors[$penalty->status] ?? 'bg-gray-50 text-gray-600 border-gray-100'); ?>">
                                <span class="w-1.5 h-1.5 rounded-full <?php echo e($statusDots[$penalty->status] ?? 'bg-gray-400'); ?>"></span>
                        ...
                        <td class="p-5 text-center">
                            <div class="flex items-center justify-center gap-2">
                                <a href="<?php echo e(route('admin.penalties.edit', $penalty->id)); ?>" class="w-9 h-9 flex items-center justify-center rounded-xl bg-gray-900 text-white hover:bg-emerald-600 transition-all shadow-sm" title="Edit Penalty">
                                    <i class="bi bi-pencil-square"></i>
                                </a>
                                <form action="<?php echo e(route('admin.penalties.destroy', $penalty->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this penalty record?')">
...
<form id="bulkPenaltyApproveForm" action="<?php echo e(route('admin.penalties.bulkApprove')); ?>" method="POST" class="hidden">
    <?php echo csrf_field(); ?>
...
<script>
    function penaltiesBulkApproval() {
        return {
            ...
            selectedPenalties: [],
            pendingIds: <?php echo json_encode($penalties->getCollection()->filter(fn ($penalty) => $penalty->status === 'pending')->pluck('id')->values(), 15, 512) ?>,
            selectAll: false,
            get hasPendingRows() {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views/admin/penalties/index.blade.php ENDPATH**/ ?>