...
<?php $__env->startSection('title', 'Trashed Announcements'); ?>
<?php $__env->startSection('page-title', 'Trashed Announcements'); ?>
...
<div class="glass-card p-8 mb-8 relative overflow-hidden group">
    ...
    <div class="absolute -right-20 -top-20 w-64 h-64 bg-red-500/5 rounded-full blur-3xl group-hover:bg-red-500/10 transition-all duration-700"></div>
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
        <div>
            ...
            <p class="mt-2 text-gray-600 text-lg max-w-xl">
                Review and manage announcements that have been moved to trash.
            </p>
        </div>
        ...
        <div class="flex items-center gap-3">
            ...
            <button @click="toggleSelectionMode()" 
                    :class="selectionMode ? 'bg-gray-100 text-gray-700' : 'bg-red-50 text-red-700'"
...
<template x-if="selected.length > 0">
    <div class="fixed bottom-8 left-1/2 -translate-x-1/2 z-50 bg-gray-900 text-white px-6 py-4 rounded-2xl shadow-2xl flex items-center gap-6 animate-fade-in border border-white/10">
        ...
        <div class="flex items-center gap-3">
            ...
            <form action="<?php echo e(route('admin.announcements.bulkForceDelete')); ?>" method="POST" onsubmit="return confirm('PERMANENTLY DELETE selected announcements? This cannot be undone.')">
                <?php echo csrf_field(); ?>
...
<div class="space-y-4">
    <h4 class="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-4 px-1">Trashed Items</h4>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views/admin/announcements/trashed-announcements.blade.php ENDPATH**/ ?>