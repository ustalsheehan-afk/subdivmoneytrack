...
<head>
    ...
    <title>Official Receipt #<?php echo e(str_pad($payment->id, 8, '0', STR_PAD_LEFT)); ?></title>
            ...
            <div class="flex justify-between items-start mb-10">
                ...
                <div class="text-right">
                    ...
                    <div class="inline-block px-3 py-1 bg-emerald-50 border border-emerald-100 rounded-lg mt-2">
                        <p class="text-[10px] font-black text-emerald-700 uppercase tracking-widest">Receipt No. #<?php echo e(str_pad($payment->id, 8, '0', STR_PAD_LEFT)); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-8 mb-10 pb-8 border-b border-gray-100">
                <div class="space-y-4">
                    <div>
                        ...
                        <p class="text-sm font-bold text-gray-800"><?php echo e($payment->date_paid->format('M d, Y • h:i A')); ?></p>
                    </div>
                    <div>
                ...
                <div class="space-y-4 text-right">
                    <div>
                        ...
                        <p class="text-sm font-black text-gray-900 uppercase"><?php echo e($payment->resident->full_name); ?></p>
                        <p class="text-[11px] font-bold text-emerald-600 mt-0.5">Block <?php echo e($payment->resident->block); ?> / Lot <?php echo e($payment->resident->lot); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex-grow">
                <div class="bg-gray-50 rounded-2xl p-6 mb-8 border border-gray-100/50">
                    ...
                    <div class="flex justify-between items-start">
                        <div>
                            <h3 class="text-base font-black text-gray-900 uppercase"><?php echo e($payment->due->title); ?></h3>
                            <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-1"><?php echo e(str_replace('_', ' ', $payment->due->type)); ?></p>
                        </div>
                        <div class="text-right">
                            <p class="text-xl font-black text-gray-900 italic">₱<?php echo e(number_format($payment->amount, 2)); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-3 px-2">
                    <div class="flex justify-between items-center text-sm">
                        ...
                        <span class="font-black text-gray-900 uppercase tracking-widest text-xs px-3 py-1 bg-white border border-gray-200 rounded-lg"><?php echo e($payment->payment_method); ?></span>
                    </div>
                    <?php if($payment->reference_no): ?>
                    <div class="flex justify-between items-center text-sm">
                        <span class="text-gray-500 font-medium">Reference No.</span>
                        <span class="font-bold text-gray-800"><?php echo e($payment->reference_no); ?></span>
                    </div>
                    <?php endif; ?>
                    <div class="pt-4 mt-4 border-t border-gray-100 flex justify-between items-end">
                        <div>
                            ...
                            <p class="text-4xl font-black text-[#0D1F1C] tracking-tighter mt-1 italic">₱<?php echo e(number_format($payment->amount, 2)); ?></p>
                        </div>
                        <div class="text-right">
                            <?php $balance = $payment->due->balance; ?>
                            <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Remaining Balance</p>
                            <p class="text-lg font-black <?php echo e($balance > 0 ? 'text-red-500' : 'text-emerald-500'); ?> mt-1 italic">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="text-right">
                        ...
                        <div class="inline-block p-2 bg-white border border-gray-100 rounded-xl shadow-sm mb-2">
                            <img src="<?php echo e($qr); ?>" alt="Verification QR" class="w-16 h-16 grayscale contrast-125 opacity-80">
                        </div>
...
<?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views\admin\payments\receipt.blade.php ENDPATH**/ ?>