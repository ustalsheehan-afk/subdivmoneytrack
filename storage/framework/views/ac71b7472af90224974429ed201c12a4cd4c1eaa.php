...
<?php $__env->startSection('page-title', 'Create Announcement'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-32">
    <form method="POST" action="<?php echo e(route('admin.announcements.store')); ?>" enctype="multipart/form-data" id="announcementForm">
        <?php echo csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="datetime-local"
                                       ...
                                       value="<?php echo e(old('date_posted', now()->format('Y-m-d\TH:i'))); ?>"
                                       required>
                            </div>
                        ...
                        <div class="relative pl-8">
                            ...
                            <div class="flex items-center gap-6 mt-auto pt-6 border-t border-gray-50">
                                <div class="flex items-center gap-1.5 text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                                    ...
                                    <span>0 / <?php echo e(\App\Models\Resident::where('status', 'active')->count()); ?> Seen</span>
                                </div>
                                <div class="flex items-center gap-1.5 text-[10px] font-bold text-gray-400 uppercase tracking-widest">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views\admin\announcements\create.blade.php ENDPATH**/ ?>