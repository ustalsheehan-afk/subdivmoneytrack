<?php $__env->startSection('title', 'Edit Billing Statement'); ?>
<?php $__env->startSection('page-title', 'Edit Billing'); ?>
...
<div class="space-y-8 animate-fade-in pb-20">
            ...
            <div class="flex items-center gap-6">
                ...
                <div>
                    ...
                    <p class="mt-2 text-gray-600 text-lg max-w-xl">
                        Update the details of the billing batch: <span class="font-bold text-gray-900"><?php echo e($batch->title); ?></span>
                    </p>
                </div>
            </div>
        </div>
    ...
    <form id="edit-billing-form" action="<?php echo e(route('admin.dues.update', $batch->id)); ?>" method="POST" x-data="billingForm()">
        <?php echo csrf_field(); ?>
                ...
                <section class="glass-card p-8 space-y-8 relative overflow-hidden group">
                    ...
                    <div class="grid grid-cols-1 gap-8">
                        <div class="space-y-3">
                            ...
                            <input type="text" name="title" id="title" value="<?php echo e(old('title', $batch->title)); ?>" oninput="updatePreview()" 
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="relative group/select">
                                    <select name="type" id="type" x-model="billingType" 
                                        ...
                                        <option value="monthly_hoa" <?php echo e(old('type', $batch->type) == 'monthly_hoa' ? 'selected' : ''); ?>>Monthly HOA Fees</option>
                                        <option value="special_assessments" <?php echo e(old('type', $batch->type) == 'special_assessments' ? 'selected' : ''); ?>>Special Assessment</option>
                                        <option value="regular_fees" <?php echo e(old('type', $batch->type) == 'regular_fees' ? 'selected' : ''); ?>>Regular Service Fees</option>
                                        <option value="amenity_dues" <?php echo e(old('type', $batch->type) == 'amenity_dues' ? 'selected' : ''); ?>>Amenity Dues</option>
                                    </select>
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="relative group/select">
                                    <select name="frequency" id="frequency" 
                                        class="w-full px-5 py-4 rounded-2xl border border-gray-200 bg-gray-50/50 text-sm font-medium appearance-none focus:bg-white focus:border-emerald-500 transition-all outline-none cursor-pointer" required>
                                        <option value="one_time" <?php echo e(old('frequency', $batch->frequency) == 'one_time' ? 'selected' : ''); ?>>One-time</option>
                                        <option value="monthly" <?php echo e(old('frequency', $batch->frequency) == 'monthly' ? 'selected' : ''); ?>>Monthly</option>
                                        <option value="quarterly" <?php echo e(old('frequency', $batch->frequency) == 'quarterly' ? 'selected' : ''); ?>>Quarterly</option>
                                    </select>
                                    <i class="bi bi-chevron-down absolute right-5 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none group-hover/select:text-emerald-600 transition-colors"></i>
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="space-y-3">
                                ...
                                <input type="date" name="due_date" id="due_date" value="<?php echo e(old('due_date', $batch->due_date ? $batch->due_date->format('Y-m-d') : '')); ?>" onchange="updatePreview()" 
                    ...
                    <div class="glass-card bg-gray-900 p-8 relative overflow-hidden group border-none">
                        ...
                        <div class="relative z-10 space-y-6">
                            ...
                            <div class="flex gap-3">
                                <a href="<?php echo e(route('admin.dues.index')); ?>" class="flex-1 py-4 rounded-2xl bg-white/10 border border-white/10 text-white text-[10px] font-black uppercase tracking-widest hover:bg-white/20 transition-all text-center">
                                    Cancel
                                </a>
...
<script>
    function billingForm() {
        return {
            billingType: '<?php echo e(old("type", $batch->type)); ?>',
            amountType: '<?php echo e(old("amount_type", $batch->amount_type ?? $batch->type)); ?>',
            amount: '<?php echo e(old("amount", $batch->amount)); ?>',
            init() {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views\admin\dues\edit.blade.php ENDPATH**/ ?>