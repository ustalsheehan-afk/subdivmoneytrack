...
<div class="premium-card">
    ...
    <div class="text-center">
        <img src="<?php echo e(asset('Cdlogo.jpg')); ?>" alt="Logo" class="premium-logo">
    ...
    <form method="POST" action="<?php echo e(route('resident.register.submit')); ?>">
        <?php echo csrf_field(); ?>
    ...
    <div class="text-center mt-4">
        <p class="small text-slate-500 mb-0">
            ...
            <a href="<?php echo e(route('resident.login')); ?>" class="font-semibold text-blue-600 hover:text-blue-700 text-decoration-none ms-1">
                Login here
            </a>
        </p>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views\auth\resident-register.blade.php ENDPATH**/ ?>