...
<?php $__env->startSection('page-title', 'Edit Request'); ?>
...
<div class="h-full bg-[#F8F9FB] overflow-y-auto custom-scrollbar">
    <div class="max-w-4xl mx-auto px-6 py-8 flex flex-col gap-8 pb-24 animate-fade-in">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
                <div class="inline-flex items-center gap-2 px-3 py-1 rounded-lg bg-emerald-500/10 border border-emerald-500/20 mb-3">
                    ...
                    <span class="text-[10px] font-black text-emerald-500 uppercase tracking-widest">Update Ticket #<?php echo e(str_pad($requestItem->id, 4, '0', STR_PAD_LEFT)); ?></span>
                </div>
        ...
        <form action="<?php echo e(route('resident.requests.update', $requestItem->id)); ?>" method="POST" enctype="multipart/form-data" class="space-y-8">
            <?php echo csrf_field(); ?>
                ...
                <div class="relative z-10 grid grid-cols-1 gap-10">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="type" id="type" value="<?php echo e(old('type', $requestItem->type)); ?>" required
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="relative">
                            ...
                            <textarea name="description" rows="5" required placeholder="Please describe your request in detail..."
                                      class="w-full bg-gray-50 border border-gray-100 rounded-2xl pl-14 pr-6 py-6 text-sm font-black text-gray-900 focus:bg-white focus:ring-4 focus:ring-emerald-500/5 focus:border-emerald-500 transition-all outline-none resize-none"><?php echo e(old('description', $requestItem->description)); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="relative">
                                ...
                                <select name="priority"
                                    ...
                                    <option value="Low" <?php echo e(old('priority', $requestItem->priority) == 'Low' ? 'selected' : ''); ?>>LOW - NOT URGENT</option>
                                    <option value="Medium" <?php echo e(old('priority', $requestItem->priority) == 'Medium' ? 'selected' : ''); ?>>MEDIUM - NORMAL</option>
                                    <option value="High" <?php echo e(old('priority', $requestItem->priority) == 'High' ? 'selected' : ''); ?>>HIGH - URGENT</option>
                                </select>
                        ...
                        <div class="space-y-3">
                            ...
                            <label for="photo"
                                ...
                                <span id="photoLabel"><?php echo e($requestItem->photo ? 'Change Photo' : 'Upload Photo'); ?></span>
                            </label>
                        </div>
                    </div>

                    
                    <div id="imagePreviewContainer" class="<?php echo e($requestItem->photo ? '' : 'hidden'); ?> pt-8 border-t border-gray-50 text-center animate-fade-in">
                        ...
                        <div class="relative inline-block group/preview">
                            ...
                            <img id="imagePreview" src="<?php echo e($requestItem->photo ? asset('storage/' . $requestItem->photo) : '#'); ?>" 
...
function clearImage(){
    ...
    input.value = '';
    preview.src = '<?php echo e($requestItem->photo ? asset("storage/" . $requestItem->photo) : "#"); ?>';
...
<?php echo $__env->make('resident.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views\resident\requests\edit.blade.php ENDPATH**/ ?>