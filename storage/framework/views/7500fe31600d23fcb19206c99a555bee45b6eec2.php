...
?>
<div onclick="loadRequestDetails(<?php echo e(json_encode($requestData)); ?>)"
    ...
    <span class="absolute top-6 right-6 px-3 py-1.5 rounded-full text-[9px] font-black uppercase tracking-widest border <?php echo e($statusClasses); ?>">
    ...
    <div class="flex flex-col items-center text-center mt-4 relative z-10">
        ...
        <h3 class="text-base font-black text-gray-900 group-hover:text-brand-accent transition leading-tight mb-1 truncate w-full">
            <?php echo e($req->resident->full_name ?? 'Unknown Resident'); ?>

        </h3>
        <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-4">BLK <?php echo e($req->resident->block ?? '-'); ?> • LOT <?php echo e($req->resident->lot ?? '-'); ?></p>
        
        <p class="text-sm font-black text-gray-800 mb-6 uppercase tracking-widest bg-gray-50 px-3 py-1.5 rounded-lg border border-gray-100"><?php echo e($req->type); ?></p>
        ...
        <div class="w-full border-t border-gray-50 pt-5 flex flex-col gap-3">
            <div class="flex justify-between items-center w-full">
                ...
                <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest border <?php echo e($priorityClasses); ?>">
            ...
            <div class="flex justify-between items-center w-full">
                ...
                <div class="text-right">
                    <span class="text-[10px] font-black text-gray-600 tracking-tight block"><?php echo e($req->created_at->format('M d, Y')); ?></span>
                    <span class="text-[8px] font-bold text-gray-400 uppercase tracking-tight"><?php echo e($req->created_at->diffForHumans()); ?></span>
                </div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views\admin\requests\partials\card.blade.php ENDPATH**/ ?>