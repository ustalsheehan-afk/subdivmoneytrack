...
<div class="d-flex justify-content-center align-items-center min-vh-100">
    <div class="card login-card">
        ...
        <div class="text-center mb-3">
            ...
            <h4 class="fw-bold text-primary mb-1">Reset Password</h4>
            <p class="text-muted small mb-3">Create a new password</p>
        </div>
        ...
        <form method="POST" action="<?php echo e(route('password.update')); ?>">
            ...
            <div class="mb-3">
                <input type="email" name="email" id="email"
                       class="form-control rounded-pill ps-4 pe-5 py-2 <?php $__errorArgs = ['email'];
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views\auth\resident-reset-password.blade.php ENDPATH**/ ?>