...
<?php $__env->startSection('title', 'Accounts Management'); ?>
<?php $__env->startSection('page-title', 'Accounts Management'); ?>
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
            ...
            <div class="flex items-center gap-3">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage_users')): ?>
                    <a href="<?php echo e(route('admin.accounts.create')); ?>" class="btn-premium">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="glass-card p-8 flex items-center gap-6 group hover:shadow-xl transition-all duration-300">
            ...
            <div>
                ...
                <h3 class="text-3xl font-black text-gray-900 tracking-tight tabular-nums"><?php echo e($accounts->count()); ?></h3>
            </div>
        </div>
        ...
        <div class="glass-card p-8 flex items-center gap-6 group hover:shadow-xl transition-all duration-300">
            ...
            <div>
                ...
                <h3 class="text-3xl font-black text-gray-900 tracking-tight tabular-nums"><?php echo e($accounts->where('active', true)->count()); ?></h3>
            </div>
        </div>
        ...
        <div class="glass-card p-8 flex items-center gap-6 group hover:shadow-xl transition-all duration-300">
            ...
            <div>
                ...
                <h3 class="text-3xl font-black text-gray-900 tracking-tight tabular-nums"><?php echo e($accounts->where('role', 'admin')->count()); ?></h3>
            </div>
        </div>
    </div>
    ...
    <?php if(session('success')): ?>
        <div class="bg-emerald-50 border border-emerald-100 p-6 rounded-[24px] flex items-center gap-4 animate-zoom-in">
            ...
            <div>
                ...
                <p class="text-sm font-bold text-emerald-600"><?php echo e(session('success')); ?></p>
            </div>
        </div>
    <?php endif; ?>
                ...
                <tbody class="divide-y divide-gray-50" id="accountsTableBody">
                    <?php $__empty_1 = true; $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="account-row group hover:bg-emerald-50/30 transition-all duration-300 border-l-4 border-transparent hover:border-emerald-500" 
                            data-name="<?php echo e(strtolower($account->name)); ?>" 
                            data-email="<?php echo e(strtolower($account->email)); ?>"
                            data-status="<?php echo e($account->active ? 'active' : 'inactive'); ?>"
                            data-role="<?php echo e($account->role === 'resident' ? 'resident' : ($account->rbacRole->name ?? 'admin')); ?>">
                            ...
                            <td class="px-8 py-6">
                                <div class="flex items-center gap-4">
                                    <div class="w-12 h-12 rounded-[16px] bg-gray-50 flex items-center justify-center text-sm font-black text-gray-600 border border-gray-100 shadow-sm group-hover:scale-110 group-hover:bg-emerald-50 group-hover:text-emerald-600 transition-all duration-500">
                                        <?php echo e(substr($account->name, 0, 1)); ?>

                                    </div>
                                    <div class="min-w-0">
                                        <p class="text-sm font-black text-gray-900 group-hover:text-emerald-700 transition-colors truncate"><?php echo e($account->name); ?></p>
                                        <p class="text-[10px] font-bold text-gray-400 uppercase tracking-tight truncate"><?php echo e($account->email); ?></p>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-8 py-6">
                                ...
                                <?php else: ?>
                                    ...
                                    ?>
                                    <span title="User Role determines access level" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-[9px] font-black uppercase tracking-widest border <?php echo e($roleStyle); ?>">
                                        <i class="bi <?php echo e($roleIcon); ?>"></i>
                                        <?php echo e(strtoupper(str_replace('_',' ', $roleName))); ?>
                                ...
                                <div x-data="{open:false}" class="relative inline-block text-left">
                                    ...
                                    <div x-show="open" x-transition 
                                        ...
                                        <div class="space-y-1">
                                            ...
                                            <form action="<?php echo e(route('admin.accounts.reset', $account->id)); ?>" method="POST"
                                                  onsubmit="return confirm('Are you sure you want to reset the password for <?php echo e($account->name); ?>?');">
                                                <?php echo csrf_field(); ?>
                                            ...
                                            <form action="<?php echo e(route('admin.accounts.toggle', $account->id)); ?>" method="POST"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views\admin\accounts\index.blade.php ENDPATH**/ ?>