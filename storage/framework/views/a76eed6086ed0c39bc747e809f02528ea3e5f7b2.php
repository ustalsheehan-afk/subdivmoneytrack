...
<div class="h-full bg-[#F8F9FB] overflow-y-auto custom-scrollbar">
    ...
    <div class="bg-white border-b border-gray-100 px-8 py-5 flex items-center justify-between sticky top-0 z-30 shadow-sm">
        <div class="flex items-center gap-4">
            <a href="<?php echo e(route('resident.my-reservations.index')); ?>" class="w-10 h-10 flex items-center justify-center rounded-xl bg-gray-50 text-gray-400 hover:text-emerald-600 hover:bg-emerald-50 border border-transparent hover:border-emerald-100 transition-all group">
        ...
        <div class="flex items-center gap-3">
            ...
            <span class="text-xs font-black text-gray-700 uppercase tracking-widest"><?php echo e(Auth::user()->first_name); ?></span>
        </div>
    </div>
                ...
                <div class="bg-red-50 border border-red-100 rounded-[32px] p-8 shadow-lg shadow-red-500/5">
                    <div class="flex items-start gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-red-700 font-medium leading-relaxed text-sm"><?php echo e($reservation->rejection_reason); ?></p>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="bg-gray-50 border border-gray-100 rounded-[32px] p-8 shadow-lg shadow-gray-500/5">
                    <div class="flex items-start gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700 font-medium leading-relaxed text-sm mb-4"><?php echo e($reservation->cancellation_reason); ?></p>
                            <?php if($reservation->cancelled_at): ?>
                            <p class="text-gray-500 text-xs">Cancelled on <?php echo e(\Carbon\Carbon::parse($reservation->cancelled_at)->format('M d, Y \a\t g:i A')); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-10">
                        <div class="flex items-start justify-between mb-12">
                            <div class="space-y-3">
                                ...
                                <h2 class="text-4xl font-black text-gray-900 tracking-tight leading-none"><?php echo e($reservation->amenity->name); ?></h2>
                                <p class="text-gray-400 font-black text-[10px] uppercase tracking-widest">Booking ID: #<?php echo e(str_pad($reservation->id, 6, '0', STR_PAD_LEFT)); ?></p>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                            ...
                            <div class="bg-gray-50 p-6 rounded-[24px] border border-gray-100 group hover:bg-white hover:shadow-xl transition-all duration-500">
                                ...
                                <div class="flex items-center gap-5">
                                    ...
                                    <p class="text-xl font-black text-gray-900 tracking-tight tabular-nums"><?php echo e($reservation->date->format('F j, Y')); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="bg-gray-50 p-6 rounded-[24px] border border-gray-100 group hover:bg-white hover:shadow-xl transition-all duration-500">
                                ...
                                <div class="flex items-center gap-5">
                                    ...
                                    <p class="text-xl font-black text-gray-900 tracking-tight tabular-nums"><?php echo e($reservation->time_slot); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="bg-gray-50 p-6 rounded-[24px] border border-gray-100 group hover:bg-white hover:shadow-xl transition-all duration-500">
                                ...
                                <div class="flex items-center gap-5">
                                    ...
                                    <p class="text-xl font-black text-gray-900 tracking-tight tabular-nums"><?php echo e($reservation->guest_count); ?> People</p>
                                </div>
                            </div>
                            ...
                            <div class="bg-gray-50 p-6 rounded-[24px] border border-gray-100 group hover:bg-white hover:shadow-xl transition-all duration-500">
                                ...
                                <div class="flex items-center gap-5">
                                    ...
                                    <p class="text-3xl font-black text-black tracking-tighter tabular-nums">₱<?php echo e(number_format($reservation->total_price, 2)); ?></p>
                                </div>
                            </div>
                        </div>

                        
                        <?php if(!empty($reservation->equipment_addons)): ?>
                        <div class="mt-14 pt-10 border-t border-gray-100">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                <?php $__currentLoopData = $reservation->equipment_addons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex justify-between items-center p-6 rounded-[24px] bg-gray-50 border border-gray-100 hover:bg-white hover:shadow-xl hover:border-emerald-100 transition-all duration-500 group">
                                    ...
                                    <span class="font-black text-gray-900 tracking-tight tabular-nums">₱<?php echo e(number_format($item['price'], 2)); ?></span>
                                </div>
            ...
            <div class="lg:col-span-5">
                <div class="bg-white border border-gray-100 rounded-[40px] p-10 shadow-2xl h-full flex flex-col relative overflow-hidden group/card">
                    ...
                    <div class="mb-10 relative z-10">
                        <?php if($reservation->payment_status === 'paid'): ?>
                            <div class="flex flex-col items-center text-center p-12 bg-emerald-500 rounded-[32px] border border-emerald-400 relative overflow-hidden group/status shadow-xl shadow-emerald-500/20">
                                ...
                                <p class="text-black/80 text-[10px] font-black mt-3 uppercase tracking-[0.2em] relative z-10">
                                    <?php echo e($reservation->verified_at ? \Carbon\Carbon::parse($reservation->verified_at)->format('M d, Y') : 'Transaction Completed'); ?>

                                </p>
                            </div>
                        <?php elseif($reservation->payment_status === 'submitted'): ?>
                        ...
                        <?php elseif($reservation->payment_method === 'cash'): ?>
                    ...
                    <?php if(in_array($reservation->payment_status, ['pending', 'rejected']) && $reservation->payment_method === 'gcash'): ?>
                        <form action="<?php echo e(route('resident.amenities.reservation.payment', $reservation->id)); ?>" method="POST" enctype="multipart/form-data" class="space-y-8 flex-1 flex flex-col justify-end relative z-10" x-data="{ fileName: '' }">
                            <?php echo csrf_field(); ?>
                    ...
                    <?php if($reservation->payment_proof): ?>
                        <div class="mt-auto pt-10 border-t border-gray-100 relative z-10">
                            ...
                            <div class="relative rounded-[32px] overflow-hidden border border-gray-100 group/proof shadow-xl hover:shadow-2xl transition-all duration-700">
                                <img src="<?php echo e(Storage::url($reservation->payment_proof)); ?>" class="w-full h-64 object-cover transform group-hover/proof:scale-110 transition-transform duration-1000">
                                <a href="<?php echo e(Storage::url($reservation->payment_proof)); ?>" target="_blank" 
                            ...
                            <div class="mt-8 flex items-center justify-between p-6 bg-gray-50 rounded-[24px] border border-gray-100 group/ref hover:bg-white hover:shadow-xl transition-all duration-500">
                                <div>
                                    ...
                                    <p class="text-lg font-black text-black tracking-widest font-mono tabular-nums"><?php echo e($reservation->payment_reference_no); ?></p>
                                </div>
                    ...
                    <?php if(in_array($reservation->status, ['pending', 'approved']) && !$reservation->cancelled_at): ?>
...
<div id="cancelModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 hidden flex items-center justify-center p-4">
    <div class="bg-white rounded-[32px] shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        <div class="p-8">
            ...
            <form id="cancelForm" action="<?php echo e(route('resident.amenities.reservation.cancel', $reservation->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="space-y-6">
                    <div>
                        ...
                        <select name="cancellation_reason_id" required class="w-full p-4 border-2 border-gray-50 bg-gray-50 rounded-[16px] text-sm font-medium focus:ring-0 focus:border-red-500 focus:bg-white transition-all outline-none">
                            ...
                            <?php $__currentLoopData = $cancellationReasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reason): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('resident.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views\resident\reservations\show.blade.php ENDPATH**/ ?>