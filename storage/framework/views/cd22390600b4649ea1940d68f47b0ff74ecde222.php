...
<div class="space-y-8 animate-fade-in" x-data="{ search: '' }">
    ...
    <div class="glass-card p-8 relative overflow-hidden group">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
            ...
            <div class="flex items-center gap-3">
                ...
                <form method="POST" action="<?php echo e(route('admin.dues.sendSmsReminders')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    <form id="duesSmsSelectedForm" method="POST" action="<?php echo e(route('admin.dues.sendSmsReminders')); ?>">
        <?php echo csrf_field(); ?>
                            ...
                            <?php $__currentLoopData = $batches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $batch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr class="hover:bg-emerald-50/30 transition-all duration-300 group border-l-4 border-transparent hover:border-emerald-500"
                                    ...
                                    <td class="p-5 text-center">
                                        <input type="checkbox" name="batch_ids[]" value="<?php echo e($batch->id); ?>" class="rounded border-gray-300 text-emerald-600 focus:ring-emerald-500/20">
                                    </td>
                                    <td class="p-5">
