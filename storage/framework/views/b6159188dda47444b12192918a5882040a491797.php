<div class="h-full flex flex-col bg-white shadow-2xl">
    ...
    <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-white sticky top-0 z-10">
        ...
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('admin.residents.show', $resident->id)); ?>"
    ...
    <div class="flex-1 overflow-y-auto p-6 space-y-6 bg-gray-50 custom-scrollbar">
            ...
            <div class="flex flex-col items-center text-center">
                <div class="relative p-1 rounded-full bg-gradient-to-tr from-[#800020]/30 to-transparent">
                    ...
                    <span class="absolute bottom-1 right-1 px-2 py-0.5 rounded-full text-[10px] font-semibold uppercase tracking-wider shadow-sm
                        <?php echo e($resident->status === 'active' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'); ?>">
                ...
                <p class="text-sm text-gray-500">Block <?php echo e($resident->block); ?></p>

                <div class="flex gap-3 mt-4">
                    <a href="tel:<?php echo e($resident->contact_number); ?>"
                       class="w-10 h-10 flex items-center justify-center rounded-lg bg-gray-100 text-gray-600 hover:bg-gray-200 transition"
                       title="<?php echo e($resident->contact_number); ?>">
                        <i class="bi bi-telephone-fill"></i>
                    </a>
                    <a href="mailto:<?php echo e($resident->email); ?>"
                       class="w-10 h-10 flex items-center justify-center rounded-lg bg-gray-100 text-gray-600 hover:bg-gray-200 transition">
            ...
            <div class="grid grid-cols-2 gap-3">
                <div class="p-4 rounded-xl bg-red-50 border border-red-100 text-center">
                    ...
                    <p class="text-lg font-bold text-red-700">
                        ₱<?php echo e(number_format($financials['outstandingDues'] ?? 0, 2)); ?>
                ...
                <div class="p-4 rounded-xl bg-green-50 border border-green-100 text-center">
                    ...
                    <p class="text-lg font-bold text-green-700">
                        ₱<?php echo e(number_format($financials['totalPayments'] ?? 0, 2)); ?>
        ...
        <div>
            ...
            <div id="drawer-tab-dues" class="drawer-tab-content space-y-3">
                <?php if($resident->dues && $resident->dues->count() > 0): ?>
                    <?php $__currentLoopData = $resident->dues->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $due): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex justify-between items-center p-3 rounded-xl border border-gray-100 hover:bg-gray-50 transition">
                            <div>
                                <p class="text-sm font-bold text-gray-900"><?php echo e($due->month); ?> <?php echo e($due->year); ?></p>
                                <p class="text-xs text-gray-500">
                                    <?php echo e($due->due_date ? $due->due_date->format('M d, Y') : '—'); ?>
                            ...
                            <div class="text-right">
                                ...
                                <span class="text-[10px] px-2 py-0.5 rounded-full font-semibold
                                    <?php echo e($due->status === 'paid' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'); ?>">
                    ...
                    <?php if($resident->dues->count() > 5): ?>
                        <p class="text-center text-xs text-gray-400 mt-2">
                            Showing 5 of <?php echo e($resident->dues->count()); ?> records
                        </p>
                    <?php endif; ?>
                <?php else: ?>
            ...
            <div id="drawer-tab-payments" class="drawer-tab-content hidden space-y-3">
                <?php if($resident->payments && $resident->payments->count() > 0): ?>
                    <?php $__currentLoopData = $resident->payments->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex justify-between items-center p-3 rounded-xl border border-gray-100 hover:bg-gray-50 transition">
                            <div>
                                <p class="text-sm font-bold text-gray-900">
                                    <?php echo e($payment->or_number ?? 'No OR Number'); ?>

                                </p>
                                <p class="text-xs text-gray-500">
                                    <?php echo e($payment->date_paid ? $payment->date_paid->format('M d, Y') : '—'); ?>
                            ...
                            <div class="text-right">
                                ...
                                <span class="text-[10px] px-2 py-0.5 rounded-full font-semibold
                                    <?php echo e($payment->status === 'approved' ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'); ?>">
                    ...
                    <?php if($resident->payments->count() > 5): ?>
                        <p class="text-center text-xs text-gray-400 mt-2">
                            Showing 5 of <?php echo e($resident->payments->count()); ?> records
                        </p>
                    <?php endif; ?>
                <?php else: ?>
...
<?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views\admin\residents\partials\drawer-content.blade.php ENDPATH**/ ?>