...
<div class="overflow-x-auto">
    <table class="w-full text-sm border-collapse">
        ...
        <tbody class="divide-y divide-gray-100">
            <?php if($resident->dues->count() > 0): ?>
                <?php $__currentLoopData = $resident->dues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $due): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="hover:bg-gray-50/50 transition">
                    ...
                    <td class="p-4">
                        ...
                        ?>
                        <span class="inline-flex items-center justify-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold border capitalize tracking-wide w-24 <?php echo e($statusClass); ?>">
                            <span class="w-1.5 h-1.5 rounded-full <?php echo e($dotClass); ?>"></span>
                            <?php echo e(ucwords(str_replace('_', ' ', $due->status))); ?>
...
<?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views\admin\residents\partials\dues-table.blade.php ENDPATH**/ ?>