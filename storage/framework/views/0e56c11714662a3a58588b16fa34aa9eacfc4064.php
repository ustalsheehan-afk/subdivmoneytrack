<?php $__env->startSection('title', 'Add Board Member'); ?>
<?php $__env->startSection('page-title', 'Add Board Member'); ?>
...
<div class="space-y-8 animate-fade-in">
    ...
    <div class="max-w-4xl mx-auto">
        <form action="<?php echo e(route('admin.board.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-8">
            <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="url" name="facebook" id="facebook" value="<?php echo e(old('facebook')); ?>" 
                                           class="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl text-sm font-bold text-gray-700 focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all outline-none" 
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <textarea name="bio" id="bio" rows="4" 
                                              ...
                                              placeholder="Brief description or quote..."><?php echo e(old('bio')); ?></textarea>
                                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views\admin\board\create.blade.php ENDPATH**/ ?>