<script>
    function openModal(id, title, content, date, category, accentColor, iconClass, imagePath = null) {
        ...
        if (imagePath && modalImage && modalImageContainer) {
            modalImage.src = '<?php echo e(asset("storage")); ?>/' + imagePath;
...
</script><?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views/admin/announcements/partials/modal-script.blade.php ENDPATH**/ ?>