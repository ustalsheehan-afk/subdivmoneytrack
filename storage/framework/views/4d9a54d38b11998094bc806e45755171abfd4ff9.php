...
<?php $__env->startSection('page-title', 'Resident Details'); ?>
...
<div class="space-y-8 animate-fade-in pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <?php else: ?>
                        <button onclick="generateInvite(<?php echo e($resident->id); ?>, '<?php echo e($resident->email); ?>')"
                    ...
                    <?php endif; ?>
                    <a href="<?php echo e(route('admin.residents.edit', $resident->id)); ?>" 
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                ...
                <div class="lg:col-span-2 flex flex-col items-center gap-4">
                    ...
                    <span class="px-4 py-1.5 rounded-full bg-emerald-50 text-emerald-600 text-[9px] font-black uppercase tracking-widest border border-emerald-100 flex items-center gap-1.5">
                        ...
                        <?php echo e(strtoupper($resident->status)); ?>
                    ...
                    <div class="bg-gray-50/50 rounded-2xl p-4 border border-gray-100 group hover:bg-white hover:border-emerald-200 transition-all">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-black text-gray-900 tracking-tight"><?php echo e($resident->full_name); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50/50 rounded-2xl p-4 border border-gray-100 group hover:bg-white hover:border-emerald-200 transition-all">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-black text-gray-900 tracking-tight"><?php echo e($resident->contact_number ?? 'N/A'); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50/50 rounded-2xl p-4 border border-gray-100 group hover:bg-white hover:border-emerald-200 transition-all">
                        <div class="flex items-center gap-4">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="text-sm font-black text-gray-900 tracking-tight truncate"><?php echo e($resident->email); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50/50 rounded-2xl p-4 border border-gray-100 group hover:bg-white hover:border-emerald-200 transition-all">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-black text-gray-900 tracking-tight"><?php echo e($resident->block); ?> / <?php echo e($resident->lot); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50/50 rounded-2xl p-4 border border-gray-100 group hover:bg-white hover:border-emerald-200 transition-all">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-black text-gray-900 tracking-tight"><?php echo e($resident->move_in_date ? $resident->move_in_date->format('M d, Y') : 'N/A'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="text-center space-y-2 group">
                    ...
                    <div>
                        ...
                        <h4 class="text-xl font-black text-gray-900">₱<?php echo e(number_format($financials['outstandingDues'] ?? 0, 2)); ?></h4>
                    </div>
                </div>
                ...
                <div class="text-center space-y-2 group">
                    ...
                    <div>
                        ...
                        <h4 class="text-xl font-black text-gray-900">₱<?php echo e(number_format($financials['totalPayments'] ?? 0, 2)); ?></h4>
                    </div>
                </div>
                ...
                <div class="text-center space-y-2 group">
                    ...
                    <div>
                        ...
                        <h4 class="text-xl font-black text-gray-900">₱<?php echo e(number_format($financials['totalPenalties'] ?? 0, 2)); ?></h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white rounded-[32px] shadow-sm border border-gray-100 overflow-hidden transition-all duration-500 hover:shadow-xl hover:shadow-emerald-500/5 min-h-[500px] flex flex-col">
        ...
        <div class="flex items-center px-8 border-b border-gray-100 bg-gray-50/30">
            <?php $__currentLoopData = ['dues' => 'Dues', 'payments' => 'Payments', 'penalties' => 'Penalties', 'notes' => 'Notes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button onclick="showTab('<?php echo e($key); ?>')" 
                        class="tab-btn px-8 py-6 text-[11px] font-black uppercase tracking-widest relative transition-all group <?php echo e($loop->first ? 'active text-gray-900' : 'text-gray-400 hover:text-gray-600'); ?>"
                        data-tab="<?php echo e($key); ?>">
                    <?php echo e($label); ?>

                    <div class="absolute bottom-0 left-8 right-8 h-1 bg-[#B6FF5C] rounded-t-full transition-all duration-300 <?php echo e($loop->first ? 'scale-x-100' : 'scale-x-0'); ?> active-indicator"></div>
                </button>
        ...
        <div class="p-8 flex-1">
            <div id="tab-dues" class="tab-content animate-fade-in">
                <?php echo $__env->make('admin.residents.partials.dues-table', ['dues' => $resident->dues ?? []], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>

            <div id="tab-payments" class="tab-content hidden animate-fade-in">
                <?php echo $__env->make('admin.residents.partials.payments-table', ['payments' => $resident->payments ?? []], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>

            <div id="tab-penalties" class="tab-content hidden animate-fade-in">
                <?php echo $__env->make('admin.residents.partials.penalties-table', ['penalties' => $resident->penalties ?? []], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
                ...
                <div class="max-w-3xl space-y-6">
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder="Admin remarks about this resident..."><?php echo e($resident->notes ?? ''); ?></textarea>
                    </div>
                    <div class="flex justify-end">
                        <button onclick="saveNotes(<?php echo e($resident->id); ?>)" class="px-8 py-4 bg-[#0D1F1C] text-[#B6FF5C] rounded-2xl font-black uppercase tracking-widest text-[10px] hover:bg-[#1a2e2a] transition-all active:scale-95 flex items-center gap-2 shadow-lg shadow-emerald-500/10">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views\admin\residents\show.blade.php ENDPATH**/ ?>