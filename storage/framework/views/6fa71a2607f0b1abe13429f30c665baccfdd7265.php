...
<?php $__env->startSection('page-title', 'New Request'); ?>
...
<div class="h-full bg-[#F8F9FB] overflow-y-auto custom-scrollbar">
    <div class="max-w-4xl mx-auto px-6 py-8 flex flex-col gap-8 pb-24 animate-fade-in">
        ...
        <form action="<?php echo e(route('resident.requests.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-8">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('resident.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sheehan\subdivision-dues-system-final\resources\views\resident\requests\create.blade.php ENDPATH**/ ?>