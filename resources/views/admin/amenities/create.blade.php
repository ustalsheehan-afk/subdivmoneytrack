            ...
            <div class="p-8 space-y-8">
                        ...
                        @foreach(['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'] as $day)
                            <label class="cursor-pointer">
                                <input type="checkbox" name="days_available[]" value="{{ $day }}" class="peer sr-only"
                                    {{ in_array($day, old('days_available', [])) ? 'checked' : '' }}>
                            ...
                            <label class="flex items-center gap-3 cursor-pointer group">
                                <div class="relative flex items-center">
                                    <input type="checkbox" name="time_slots[]" value="{{ $slot }}" 
                                           ...
                                           {{ in_array($slot, old('time_slots', [])) ? 'checked' : '' }}>
                                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="max_capacity" value="{{ old('max_capacity', 1) }}" required min="1"
                               class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500 p-3 text-sm"
                               placeholder="1">
                ...
                <div>
                    ...
                    <textarea name="description" rows="4"
                              class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500 p-3 text-sm"
                              placeholder="Describe the amenity and its features...">{{ old('description') }}</textarea>
                </div>
