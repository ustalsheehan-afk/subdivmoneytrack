            ...
            <div class="relative z-10 space-y-4">
                ...
                <div class="flex items-center justify-between">
                    <div class="text-center px-4">
                        <div class="text-2xl font-black text-emerald-600">{{ $batch->resident_status_counts['paid'] }}</div>
                    ...
                    <div class="text-center px-4 border-x border-gray-100">
                        <div class="text-2xl font-black text-amber-500">{{ $batch->resident_status_counts['partial'] }}</div>
                        <div class="text-[9px] font-black text-gray-400 uppercase tracking-widest mt-1">Partial</div>
                    </div>
                    <div class="text-center px-4">
                        <div class="text-2xl font-black text-red-500">{{ $batch->resident_status_counts['unpaid'] }}</div>
