        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="group hover:bg-slate-50 transition-all cursor-pointer" onclick="window.location.href='{{ route('resident.penalties.show', $penalty->id) }}'">
                        <td class="px-8 py-6">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-sm font-bold text-slate-900 leading-none mb-1">{{ $penalty->reason }}</p>
                                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-wider">{{ $penalty->type }}</p>
                                </div>
                            </div>
                        </td>
                        <td class="px-8 py-6 text-sm font-black text-slate-900">₱{{ number_format($penalty->amount, 2) }}</td>
                        <td class="px-8 py-6 text-[11px] font-bold text-slate-400 uppercase tracking-wider">{{ $penalty->date_issued->format('M d, Y') }}</td>
