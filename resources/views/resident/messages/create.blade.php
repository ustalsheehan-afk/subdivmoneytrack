        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="body" rows="6" 
                                ...
                                placeholder="Describe your inquiry in detail..." required>{{ old('body') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-4 pt-2">
                    ...
                    <a href="{{ route('resident.messages.index') }}" class="block w-full py-5 text-center text-gray-500 text-sm font-bold hover:text-gray-700 transition-all">
                        Cancel / Back
                    </a>
                </div>
            </div>
