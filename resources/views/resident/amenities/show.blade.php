                                        ...
                                        <p class="text-[9px] font-black uppercase tracking-widest mt-1 transition-colors"
                                           :class="guestCount > maxCapacity ? 'text-red-500 animate-pulse' : 'text-gray-400'">
                                            <template x-if="guestCount > maxCapacity">
                                                <span><i class="bi bi-exclamation-circle-fill"></i> Exceeds Max Capacity ({{ $amenity->max_capacity }})</span>
                                            </template>
                                            <template x-if="guestCount <= maxCapacity">
                                                <span>Maximum Capacity: {{ $amenity->max_capacity }} PAX</span>
                                            </template>
                                        </p>
                                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                            <div class="space-y-8">
                                ...
                                <div class="flex items-start gap-6 bg-gray-50 p-6 rounded-[32px] border border-gray-100">
                                    ...
                                    <div class="space-y-2">
                                        <h4 class="text-2xl font-black text-gray-900 tracking-tight">{{ $amenity->name }}</h4>
                                        <p class="text-sm font-medium text-gray-500 leading-relaxed">{{ Str::limit($amenity->description, 100) }}</p>
                                        <div class="pt-2">
                            ...
                            <div class="space-y-8">
                                ...
                                <div class="bg-white rounded-[32px] border border-gray-100 p-8 space-y-6 shadow-sm">
                                    <div class="flex justify-between items-center py-3 border-b border-gray-50">
                                        ...
                                        <span class="text-sm font-black text-gray-900 tracking-tight">{{ Auth::user()->name }}</span>
                                    </div>
                                    <div class="flex justify-between items-center py-3 border-b border-gray-50">
                             ...
                             <div class="bg-[#081412] rounded-[40px] p-10 shadow-2xl relative overflow-hidden text-center group">
                                ...
                                <div class="relative z-10 space-y-8">
                                    ...
                                    <div class="bg-white p-6 rounded-[32px] inline-block shadow-2xl relative group/qr">
                                        <img src="{{ asset('images/gcash-qr.jpg') }}" alt="GCash QR" class="w-56 h-56 object-contain">
