...
<div class="status-card">
    ...
    <div class="card-header-status {{ $headerClass }}">
        ...
        <h2 class="fw-bold mb-0" style="font-size: 1.75rem;">{{ $title }}</h2>
    </div>

    <div class="card-body-status">
        <p class="status-message">
            {{ $message ?? 'This invitation link is no longer valid or has expired.' }}
        </p>

        <a href="{{ route('resident.login') }}" class="btn-status">
