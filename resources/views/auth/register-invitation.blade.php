    ...
    <div class="register-card">
        ...
        <div class="visual-side">
            <div class="content-box">
                ...
                <p>
                    Welcome, {{ $invitation->first_name }}! Please complete your registration to access your resident dashboard.
                </p>
        ...
        <div class="form-side custom-scrollbar">
            <div class="form-header">
                <img src="{{ asset('Cdlogo.jpg') }}" alt="Logo" class="form-logo mx-auto">
                <h1>Complete Your Registration,<br><span style="color: var(--brand-accent);">{{ $invitation->first_name }} {{ $invitation->last_name }}</span>!</h1>
            ...
            <form action="{{ route('register.invitation.submit') }}" method="POST">
                    ...
                    <div class="form-group-custom">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="first_name" class="form-control-custom" 
                                   value="{{ old('first_name', $invitation->first_name) }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group-custom">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="last_name" class="form-control-custom" 
                                   value="{{ old('last_name', $invitation->last_name) }}" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group-custom">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="contact_number" class="form-control-custom @error('contact_number') is-invalid @enderror" 
                                   value="{{ old('contact_number', $invitation->phone) }}" placeholder="09XX XXX XXXX" required>
                        </div>
                ...
                <div class="form-grid">
                    <div class="form-group-custom">
                        ...
                        <div class="input-wrapper">
                            ...
                            <select name="block" class="form-control-custom @error('block') is-invalid @enderror" required>
                                <option value="" disabled selected>Select Block</option>
                                @for($i = 1; $i <= 50; $i++)
                                    <option value="{{ $i }}" {{ old('block') == $i ? 'selected' : '' }}>Block {{ $i }}</option>
                                @endfor
                            </select>
                        </div>
                        @error('block')
                    ...
                    <div class="form-group-custom">
                        ...
                        <div class="input-wrapper">
                            ...
                            <select name="lot" class="form-control-custom @error('lot') is-invalid @enderror" required>
                                <option value="" disabled selected>Select Lot</option>
                                @for($i = 1; $i <= 100; $i++)
                                    <option value="{{ $i }}" {{ old('lot') == $i ? 'selected' : '' }}>Lot {{ $i }}</option>
                                @endfor
                            </select>
                        </div>
                        @error('lot')
                ...
                <div class="form-group-custom">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="date" name="move_in_date" class="form-control-custom @error('move_in_date') is-invalid @enderror" 
