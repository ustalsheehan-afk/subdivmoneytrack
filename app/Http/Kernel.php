...
class Kernel extends HttpKernel
{
 ...
 protected $routeMiddleware = [
    ...
    // Optional separate session middleware for custom cookies
    'admin.session' => \App\Http\Middleware\AdminSession::class,
    'resident.session' => \App\Http\Middleware\ResidentSession::class,

    // Resident profile check
    'resident.profile' => \App\Http\Middleware\ResidentProfileMiddleware::class,
